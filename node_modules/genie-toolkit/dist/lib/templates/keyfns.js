...
function paramKeyFn(slot) {
    ...
    return {
        ...
        is_array: slot.type instanceof thingtalk_1.Type.Array,
        elem: slot.type instanceof thingtalk_1.Type.Array ? slot.type.elem : null,
        is_numeric_elem: slot.type instanceof thingtalk_1.Type.Array ? slot.type.elem.isNumeric() : false,
        associatedIdType: id && !id.is_input ? id.type : null,
